...
This directory holds an **alternative execution mode** for specback in which
...
Mode B is **not** required for normal specback use; treat this directory as
a reference variant.
...
- Hosts integrating specback into a non-Claude-Code runtime should ensure
