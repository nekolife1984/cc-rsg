<!-- meta: Global configuration (goal.json), runtime state (state.json), question bank (questions.json), WBS (wbs.json), inventory (inventory.json), source map (source-map.json) -->
