...
>| the body via the Write tool into `{output_dir}/drafts/NN-slug.md`; the return value
...
```
Chapter NN saved: {output_dir}/drafts/NN-slug.md (XXX lines, NN refs, N code blocks, N mermaid)
...
| NN | slug | {output_dir}/drafts/NN-slug.md | INV-xxx,INV-yyy | XXX lines | short key-topic phrase |
```
