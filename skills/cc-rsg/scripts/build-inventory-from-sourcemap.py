#!/usr/bin/env python3
"""
cc-rsg build-inventory-from-sourcemap.py
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    p.add_argument(
        "--output", type=Path, default=".cc-rsg/inventory.json",
        help="Path to output inventory.json (default: .cc-rsg/inventory.json)",
    )
    p.add_argument(
