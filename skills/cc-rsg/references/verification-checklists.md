...
- [ ] The three required files (`00-metadata.md`, `99-unresolved.md`, `traceability.md`) exist under `.cc-rsg/drafts/` or `{output_dir}/` (default: `.cc-rsg/final/`) (`coverage-check.py` checks this; missing files are ERROR).
